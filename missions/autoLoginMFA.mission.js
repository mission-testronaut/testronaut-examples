//Note that this example mission only works with a valid premium login account
...
export const loginMission =
  `Visit ${process.env.URL}.
   ...
   Set MFA code digits to 6.
   Take a screenshot.
   Click the "Begin Simulation" button to login.
   Take screenshot.
   There should be an MFA challenge. get the mfa code called "rudy-poo", then fill the MFA Code field (#mfa-code) with that code.
